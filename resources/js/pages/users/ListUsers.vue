...
<template>
    ...
    <div class="content">
        <div class="container-fluid">
            <button type="buton" class="btn btn-primary mb-2" data-toggle="modal" data-target="#createUserModal">
                Add New User
            </button>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="modal-body">
                        <form autocomplate="off">
                            ...
                            <div class="form-group">
                                ...
                                <input v-model="form.email" name="email" type="email" class="form-control " id="email" aria-describedby="nameHelp"
